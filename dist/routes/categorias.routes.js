...
exports.router.get('/', categoria_controller_1.obtenerCategorias);
//Obtener una categoría por id. PUBLICO
exports.router.get('/:id', [
    express_validator_1.check('id', "No es un id válido").isMongoId(),
    express_validator_1.check('id').custom(db_validators_1.existeCategoria),
    validar_campos_1.validarCampos
], categoria_controller_1.obtenerCategoriaPorId);
...
exports.router.delete('/:id', [
    ...
    express_validator_1.check('id').custom(db_validators_1.existeCategoria),
    validar_campos_1.validarCampos
], categoria_controller_1.categoriaDelete);
